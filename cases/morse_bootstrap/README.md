...
**注意**：GWRITE 的 E0/T/H(eV)（fort 头部）与 stdout 逐步 KINETIC/POTENTIAL/TOTAL
打印在 VERLET 主循环下不刷新——VENUS.f90 积分后直接调 GWRITE、不重调 ENERGY_1
（VENUS.f90:403 与 ：448），故这些打印全程恒为陈旧值，打印恒定不构成守恒证据；
